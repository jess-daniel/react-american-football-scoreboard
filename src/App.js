    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button onClick={() => setHome(0)} className="awayButtons__fieldGoal">Reset Home</button>
        </div>
        <div className="awayButtons">
          ...
          <button onClick={() => setAway(0)} className="awayButtons__fieldGoal">Reset Away</button>
        </div>
      </section>
    </div>
  );
